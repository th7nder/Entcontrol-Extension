...
bool INavFile::Load(std::ifstream &ifs)
{
	...
	{
		//Utils::Debug->Log("File could not be verified against magic", "", strFunctionName, Utils::DBG_LEVEL::kAlways);
		return false;
	}
	...
	{
		//Utils::Debug->Log("File version mismatch", "", strFunctionName, Utils::DBG_LEVEL::kAlways);
		return false;
	}
