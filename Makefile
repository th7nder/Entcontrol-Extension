...
OBJECTS = sdk/smsdk_ext.cpp extension.cpp natives.cpp Helper.cpp Bugs/Bugs.cpp Entity/EntityOutput.cpp Webserver/HTTP.cpp Webserver/Parser.cpp LGN/LGN.cpp Dlib.cpp $(wildcard Nav/*.cpp) $(wildcard HLLib/HLLib/*.cpp) $(wildcard HLLib/*.cpp)
...
all: check
	...
	mkdir -p $(BIN_DIR)/LGN
	mkdir -p $(BIN_DIR)/Bugs
	if [ "$(USEMETA)" = "true" ]; then \
		ln -sf $(HL2LIB)/$(LIB_PREFIX)vstdlib$(LIB_SUFFIX); \
		ln -sf $(HL2LIB)/$(LIB_PREFIX)tier0$(LIB_SUFFIX); \
		ln -sf $(HL2LIB)/$(LIB_PREFIX)tier1$(LIB_SUFFIX); \
	fi
